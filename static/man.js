...
// find train selection of option
	...
	function clicker()
	{
		...
		{	document.getElementById("mbox").innerHTML="From ";
			...
			document.getElementById("bynum").style.display="none";
			document.getElementById("byn").style.display="initial";
		...
		else
		{
			...
			document.getElementById("bynum").style.display="initial";
...
$(document).ready(function(){
		...
		{	document.getElementById("mbox").innerHTML="From ";
			document.getElementById("xbox").style.display="";
			document.getElementById("bynum").style.display="none";
			document.getElementById("byn").style.display="true";
			document.getElementById("xbox1").style.display="";
		}
		else
		{
